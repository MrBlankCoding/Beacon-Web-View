...
hero:
  name: "Beacon Web View"
  text: "Build native macOS apps with web technologies"
  tagline: "Lightweight, WebKit-based, and modern."
  actions:
    - theme: brand
      text: Get Started
...
features:
  - title: Ultra Lightweight
    details: Compared to Electron's 200MB+, Beacon apps are typically only 5-10MB.
  - title: Native WebKit
